...
- `mesh_max: 240, 198` *Obbligatorio* La coordinata più lontana rilevata dall'origine. Questo non è necessariamente l'ultimo punto esplorato, poiché il processo di ispezione avviene a zig-zag. Come con `mesh_min`, questa coordinata è relativa alla posizione della sonda.
