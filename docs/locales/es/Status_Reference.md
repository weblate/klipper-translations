...
Este documento es una referencia del estado de la impresora disponible en Klipper [macros](Command_Templates.md), [display fields](Config_Reference.md#display), y a travez del [API Server](API_Server.md).
