...
Klipper má několik zajímavých funkcí:
...
* Klipper podporuje tiskárny s více mikrokontroléry. Jeden mikrokontrolér může být například použit k ovládání extrudéru, zatímco druhý ovládá ohřívače tiskárny, zatímco třetí ovládá zbytek tiskárny. Hostitelský software Klipper implementuje synchronizaci hodin pro zohlednění driftu hodin mezi mikrokontroléry. K povolení více mikrokontrolérů není potřeba žádný speciální kód - vyžaduje to jen několik řádků navíc v konfiguračním souboru.
