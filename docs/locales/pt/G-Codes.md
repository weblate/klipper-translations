...
Este documento descreve os comandos suportados pelo Klipper. Estes comandos podem ser inseridos na guia terminal do OctoPrint.
...
`ACCELEROMETER_DEBUG_READ [CHIP=<config_name>] REG=<register>`:consulta o registro ADXL345 "registro" (por exemplo, 44 ou 0x2C). Pode ser útil para fins de depuração.
...
- `ABORT`: Este comando encerra a ferramenta de prova manual.
